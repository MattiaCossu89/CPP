...
/*   Updated: 2021/05/08 15:19:38 by mcossu           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	FragTrap::rangedAttack(ClapTrap &target) const
{
	...
	std::cout << this->identify() << " \033[32m" << this->getName() << "\033[0m tira un sacco di bulloni a \033[31m" << target.getName() << "\033[0m (range), causing ";
...
void	FragTrap::meleeAttack(ClapTrap &target) const
{
	...
	std::cout << this->identify() << " \033[32m" << this->getName() << "\033[0m sfodera la sua MACHECA..NESO contro \033[31m" << target.getName() << "\033[0m (melee), causing ";
	target.takeDamage(dmg);
}
